...
plt.text(200.,1.,'$M_{ej}$ = 0.1',horizontalalignment='center',verticalalignment='center',size = 8)
...
#----- 610 upper limit ----
plt.scatter(9.9,0.18,marker='v',color='k',s=70)
...
plt.text(40.,5.,'$M_{ej}$ = 0.05',horizontalalignment='center',verticalalignment='center',size=8)
...
#----- 610 upper limit ----
plt.scatter(11.,0.18,marker='v',color='k',s=70)
...
plt.subplots_adjust(top=0.8, bottom=0.15, left=0.15, right=0.95, hspace=0.5,
                    wspace=0.5)
plt.savefig('grb061210_610.jpg',dpi=1000)
plt.show()
