...
plt.text(30.,40.,'$E_{52}$=1.0, $M_{ej} = 0.1$',horizontalalignment='center',verticalalignment='center',size=8)
...
#----- 325 upper limit ----
plt.scatter(11.,0.48,marker='v',color='k',s=50)
...
fp1= Fong16(1.,mej1,0.001,dl_26,0.6)[1]
...
td1= Fong16(1.,mej1,0.01,dl_26,0.6)[0]
tin=np.logspace(np.log10(1.),1.+np.log10(td1),20)
#
...
tin=np.logspace(np.log10(1.),1.+np.log10(td1),20)
#
fp1= Fong16(1.,mej1,1.,dl_26,0.6)[1]
fout1= np.log10(fp1)+3.*(np.log10(tin)-np.log10(td1))
fout2= np.log10(fp1)+y*(np.log10(tin)-np.log10(td1))
fout=np.where(tin < td1,fout1,fout2)
...
plt.gca().set_ylim(1.e-4,1.e2)
plt.subplots_adjust(top=0.92, bottom=0.15, left=0.15, right=0.95, hspace=0.25,
                    wspace=0.3)
plt.ylabel('Flux (mJy)',size=9)
...
plt.text(25.,30.,'$E_{52}$=1.0 $M_{ej} = 0.05$',horizontalalignment='center',verticalalignment='center',size=8)
...
fout2= np.log10(fp1)+y*(np.log10(tin)-np.log10(td1))
fout=np.where(tin < td1,fout1,fout2)
plt.loglog(tin,10**(fout-3),'r--',lw=2.0,label='n0=0.001')
...
fout2= np.log10(fp1)+y*(np.log10(tin)-np.log10(td1))
fout=np.where(tin < td1,fout1,fout2)
plt.loglog(tin,10**(fout-3),'g--',lw=2.0,label='n0=0.01')
...
fout2= np.log10(fp1)+y*(np.log10(tin)-np.log10(td1))
fout=np.where(tin < td1,fout1,fout2)
plt.loglog(tin,10**(fout-3),'m--',lw=2.0,label='n0=0.1')


td1= Fong16(1.,mej1,1.0,dl_26,0.325)[0]
#print (td1)
tin=np.logspace(np.log10(1.),1.+np.log10(td1),20)
 
fp1= Fong16(1.,mej1,1.0,dl_26,0.325)[1]
fout1= np.log10(fp1)+3.*(np.log10(tin)-np.log10(td1))
fout2= np.log10(fp1)+y*(np.log10(tin)-np.log10(td1))
fout=np.where(tin < td1,fout1,fout2)
plt.loglog(tin,10**(fout-3),'b--',lw=2.0,label='n0=1.0')
...
plt.text(43.,30.,'$E_{52}$=0.2 $M_{ej} = 0.1$',horizontalalignment='center',verticalalignment='center',size=8)
 
plt.scatter(11.,0.48,marker='v',color='k',s=50)


td1= Fong16(2.e-1,mej1,0.001,dl_26,0.325)[0]
#print (td1)
tin=np.logspace(np.log10(1.),1.+np.log10(td1),20)
 
fp1= Fong16(2.e-1,mej1,0.001,dl_26,0.325)[1]
fout1= np.log10(fp1)+3.*(np.log10(tin)-np.log10(td1))
fout2= np.log10(fp1)+y*(np.log10(tin)-np.log10(td1))
fout=np.where(tin < td1,fout1,fout2)
plt.loglog(tin,10**(fout-3),'r--',lw=2.0,label='n0=0.001')
...
td1= Fong16(2.e-1,mej1,0.01,dl_26,0.325)[0]
#print (td1)
tin=np.logspace(np.log10(1.),1.+np.log10(td1),20)
 
fp1= Fong16(2.e-1,mej1,0.01,dl_26,0.325)[1]
fout1= np.log10(fp1)+3.*(np.log10(tin)-np.log10(td1))
fout2= np.log10(fp1)+y*(np.log10(tin)-np.log10(td1))
fout=np.where(tin < td1,fout1,fout2)
plt.loglog(tin,10**(fout-3),'g--',lw=2.0,label='n0=0.01')
...
td1= Fong16(2.e-1,mej1,0.1,dl_26,0.325)[0]
#print (td1)
tin=np.logspace(np.log10(1.),1.+np.log10(td1),20)
 
fp1= Fong16(2.e-1,mej1,0.1,dl_26,0.325)[1]
fout1= np.log10(fp1)+3.*(np.log10(tin)-np.log10(td1))
fout2= np.log10(fp1)+y*(np.log10(tin)-np.log10(td1))
fout=np.where(tin < td1,fout1,fout2)
plt.loglog(tin,10**(fout-3),'m--',lw=2.0,label='n0=0.1')
...
td1= Fong16(2.e-1,mej1,1.0,dl_26,0.325)[0]
#print (td1)
tin=np.logspace(np.log10(1.),1.+np.log10(td1),20)
 
fp1= Fong16(2.e-1,mej1,1.0,dl_26,0.325)[1]
fout1= np.log10(fp1)+3.*(np.log10(tin)-np.log10(td1))
fout2= np.log10(fp1)+y*(np.log10(tin)-np.log10(td1))
fout=np.where(tin < td1,fout1,fout2)
plt.loglog(tin,10**(fout-3),'b--',lw=2.0,label='n0=1.0')
...
plt.legend(prop=fontP,ncol=1,loc='left corner').draw_frame(False)
...
plt.text(35.,30.,'$E_{52}$=0.2 $M_{ej} = 0.05$',horizontalalignment='center',verticalalignment='center',size=8)
...
plt.gca().set_ylim(1.e-4,1.e2)
#plt.grid()
plt.savefig('grb050709_325.jpg',dpi=1000)
plt.show()
